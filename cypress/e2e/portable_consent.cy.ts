...
import { Client, toCachedConversation, useSendMessage } from "@xmtp/react-sdk";
    ...
    it("can accept a request and move it to messages", () => {
      ...
      cy.wrap(null)
        ...
        .then(async (conversation) => {
          ...
          console.log("CACHED CONVO", cachedConvo);

          const { sendMessage } = useSendMessage();
          void sendMessage(cachedConvo, "helloooo!!!");
          ...
          console.log("DID THE MESSAGE GET SENT?", messages);

          //   void sendMessage(conversation, "hello");
