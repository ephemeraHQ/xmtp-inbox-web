          ...
          >
            <div
              className={clsx(
                ...
                { 'sm:max-w-lg': size === 'sm' },
                'inline-block align-bottom bg-white dark:bg-gray-100 text-left shadow-xl transform transition-all sm:my-8 sm:align-middle w-full rounded-xl'
              )}
            >
              <div className="flex justify-between items-center py-3.5 px-5 divider">
                ...
                <button
                  type="button"
                  className="p-1 text-gray-800 rounded-full dark:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-300"
                  onClick={onClose}
                >
