...
import { useStreamAllMessages as useStreamAllMessagesFromSdk } from "@xmtp/react-sdk";
...
export const useStreamAllMessages = () => {
  ...
  const onMessage = async (message: DecodedMessage) => {
  ...
  useStreamAllMessagesFromSdk(onMessage);
};
